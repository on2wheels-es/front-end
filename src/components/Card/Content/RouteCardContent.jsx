  ...
  render() {
    ...
    return (
      <div className="inline-block flex w-96 h-44 md:flex-col md:w-72 md:h-96 bg-white hover:shadow-xl">
        ...
        <div className="flex flex-col justify-evenly md:justify-start w-80 px-5 md:h-48 md:p-5 md:relative">
          ...
          <div className="flex flex-col space-y-6 md:space-y-10 md:mt-1">
