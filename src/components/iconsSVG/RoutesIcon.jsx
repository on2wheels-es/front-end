    ...
    return (
      <span className="flex items-center text-sm" aria-label="Total de rutas desde el municipio" role="img">
        <span className="flex items-end mt-1">
          <svg width="50" height="25" style={{'fill': '#6B7280'}} viewBox="0 0 60 120" role="presentation" aria-hidden="true" focusable="false" className="self-center">
          ...
          <p className="secondary_body_regular"><span className="caption_regular ml-1">Nº de rutas:</span>{props.text}</p>
        </span>
      </span>
    )
}
